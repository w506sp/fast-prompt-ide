...
urlpatterns = [
    ...
    path('ide/templates/<int:template_pk>/favorite/', views.toggle_favorite, name='toggle_favorite'),
    path('', views.workspace_list_redirect, name='workspace_list'),
    ...
    path('projects/<int:pk>/', views.project_detail_redirect, name='project_detail'),
    path('projects/<int:project_pk>/templates/new/', views.PromptTemplateCreateView.as_view(), name='prompt_template_create'),
    path('templates/<int:pk>/', views.prompt_template_detail_redirect, name='prompt_template_detail'),
